        ...
        <div className="flex flex-col lg:flex-row items-center">
          <div className="w-full lg:w-1/2 text-center lg:text-left mb-12 lg:mb-0">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 leading-tight">
              <span className="text-gradient">Monitor everything.</span><br />
          ...
          <div className="w-full lg:w-1/2 relative">
            <div className="glass-card rounded-xl overflow-hidden shadow-2xl relative z-10">
              <div className="bg-gradient-to-r from-accent/20 to-primary/20 p-1">
            ...
            {/* Decorative elements */}
            <div className="absolute -top-20 -right-20 w-64 h-64 bg-accent/30 rounded-full filter blur-3xl opacity-20 animate-float"></div>
            <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-primary/30 rounded-full filter blur-3xl opacity-20 animate-float" style={{ animationDelay: "2s" }}></div>
          </div>
        </div>
      </div>
    </div>
